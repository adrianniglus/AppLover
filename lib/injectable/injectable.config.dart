...
import '../data/data_source/api/fake_dio_client.dart' as _i4;
import '../data/data_source/local/applover_secure_storage.dart' as _i3;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i3.ApploverSecureStorage>(_i3.ApploverSecureStorage());
  gh.factory<_i4.FakeDioClient>(() => _i4.FakeDioClient());
  gh.singleton<_i5.Mapper>(_i5.Mapper());
  await gh.factoryAsync<_i6.SharedPreferences>(
      () => sharedPreferencesModule.prefs,
      preResolve: true);
  gh.lazySingleton<_i7.AuthService>(() => _i8.AuthServiceImpl(get<_i5.Mapper>(),
      get<_i3.ApploverSecureStorage>(), get<_i4.FakeDioClient>()));
